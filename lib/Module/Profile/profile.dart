...
class Profile extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Builder(builder: (context) {
      ...
      //SocialCubit.get(context).getUserseekerPosts(SocialCubit.get(context).userModel!.uid);
                    ...
                    child: Column(
                      children: [
                        ...
                        ListView.separated(
                          shrinkWrap: true,
                          physics: NeverScrollableScrollPhysics(),
                          itemBuilder: (context, index) => buildseekerPostItem(
                          ...
                          itemCount: SocialCubit.get(context).userpostsS.length,
                        ),
                        SizedBox(
                          height: 8.0,
                        ),
